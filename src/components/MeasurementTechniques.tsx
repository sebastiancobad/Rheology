...
export default function MeasurementTechniques() {
  return (
    ...
    >
      ...
      <p className="text-[#a1a1aa] mb-6 max-w-3xl">
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        <div className="bg-[#0c0c12]/60 border border-white/[0.04] rounded-2xl backdrop-blur-sm p-6">
          ...
          <div className="bg-[#050507]/60 rounded-xl border border-white/[0.02] p-4 mb-4 font-mono text-sm text-center text-[#a1a1aa]">
            <pre>{`       ╱ cone (angle α)
      ╱─────────────╲
     ╱    sample      ╲
    ═══════════════════════
         plate (fixed)`}</pre>
          ...
          <p className="text-[#a1a1aa] text-xs mt-3 mb-2">
            <strong className="text-[#e4e4e7]">Advantages:</strong>
          </p>
          ...
          <p className="text-[#a1a1aa] text-xs mt-2 mb-1">
            <strong className="text-[#e4e4e7]">Limitations:</strong>
          </p>
          <ul className="text-[#a1a1aa] text-xs list-disc list-inside space-y-1">
        ...
        <div className="bg-[#0c0c12]/60 border border-white/[0.04] rounded-2xl backdrop-blur-sm p-6">
          <h4 className="font-bold text-[#c084fc] mb-3">
    ...
    ═══════════════════════`}</pre>
      ...
      <div className="bg-[#0c0c12]/60 border border-white/[0.04] rounded-2xl backdrop-blur-sm p-6 mb-12">
        <h4 className="font-bold text-[#fafafa] mb-4">Other Geometries &amp; Special Configurations</h4>
        <div className="grid md:grid-cols-3 gap-6">
          <div>
            <h5 className="text-[#2dd4bf] font-semibold text-sm mb-2">Concentric Cylinders (Couette)</h5>
            <p className="text-[#a1a1aa] text-xs">
              Inner cylinder (bob) rotates within an outer cup. Excellent for low-viscosity
              fluids and suspensions. The <strong className="text-[#e4e4e7]">double-gap</strong>{" "}
          ...
          <div>
            <h5 className="text-[#f0abfc] font-semibold text-sm mb-2">Vane Geometry</h5>
            <p className="text-[#a1a1aa] text-xs">
          ...
          <div>
            <h5 className="text-[#fbbf24] font-semibold text-sm mb-2">Closed-Cavity Rheometers</h5>
            <p className="text-[#a1a1aa] text-xs">
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        <div className="bg-[#0c0c12]/60 border border-white/[0.04] rounded-2xl backdrop-blur-sm p-6">
          ...
          <p className="text-[#a1a1aa] text-sm mb-3">
            Corrects for the <strong className="text-[#e4e4e7]">entrance
            pressure drop</strong> (ΔP<sub>ent</sub>) caused by extensional and
            secondary flows at the die entry. Methodology:
          </p>
          <ol className="text-[#a1a1aa] text-xs list-decimal list-inside space-y-1 mb-3">
        ...
        <div className="bg-[#0c0c12]/60 border border-white/[0.04] rounded-2xl backdrop-blur-sm p-6">
          ...
          <p className="text-[#a1a1aa] text-sm mb-3">
            ...
            <strong className="text-[#e4e4e7]">non-parabolic velocity
      ...
      <div className="bg-[#0c0c12]/60 border border-white/[0.04] rounded-2xl backdrop-blur-sm p-6 mb-12">
        <h4 className="font-bold text-[#fafafa] mb-4">Advanced Capillary Rheometry</h4>
        <div className="grid md:grid-cols-3 gap-6">
          <div>
            <h5 className="text-[#818cf8] font-semibold text-sm mb-2">Wall Slip Detection</h5>
            <p className="text-[#a1a1aa] text-xs">
              <strong className="text-[#e4e4e7]">Mooney analysis:</strong> measure apparent
          ...
          <div>
            <h5 className="text-[#c084fc] font-semibold text-sm mb-2">Pressure-Dependent Viscosity</h5>
            <p className="text-[#a1a1aa] text-xs">
          ...
          <div>
            <h5 className="text-[#2dd4bf] font-semibold text-sm mb-2">Entrance Flow Analysis (Cogswell)</h5>
            <p className="text-[#a1a1aa] text-xs">
      ...
      <div className="bg-[#0c0c12]/60 border border-white/[0.04] rounded-2xl backdrop-blur-sm p-6 mb-12">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div>
            <h5 className="text-[#818cf8] font-semibold text-sm mb-2">Slit-Die Rheometer</h5>
            <p className="text-[#a1a1aa] text-xs">
          ...
          <div>
            <h5 className="text-[#c084fc] font-semibold text-sm mb-2">Ultrasonic Rheometry</h5>
            <p className="text-[#a1a1aa] text-xs">
              Non-invasive technique using ultrasonic wave propagation to measure
              G&apos; and G&apos;&apos; at MHz frequencies. The{" "}
              <strong className="text-[#e4e4e7]">Resonic</strong> system and similar
          ...
          <div>
            <h5 className="text-[#2dd4bf] font-semibold text-sm mb-2">In-Process Monitoring</h5>
            <p className="text-[#a1a1aa] text-xs">
        ...
        <table className="w-full text-sm text-left">
          <thead>
            <tr className="border-b border-white/[0.06]">
              <th className="px-4 py-3 text-[#fafafa] font-semibold">
                Parameter
              </th>
              <th className="px-4 py-3 text-[#818cf8] font-semibold">
                Melt Flow Index (MFI)
              </th>
              <th className="px-4 py-3 text-[#c084fc] font-semibold">
          ...
          <tbody className="text-[#a1a1aa]">
            <tr className="border-b border-white/[0.06]/50">
              <td className="px-4 py-3 font-medium text-[#e4e4e7]">Standard</td>
              <td className="px-4 py-3">ASTM D1238 / ISO 1133</td>
              <td className="px-4 py-3">ASTM D4065 / ISO 6721</td>
            </tr>
            <tr className="border-b border-white/[0.06]/50">
              <td className="px-4 py-3 font-medium text-[#e4e4e7]">Measurement</td>
            ...
            <tr className="border-b border-white/[0.06]/50">
              <td className="px-4 py-3 font-medium text-[#e4e4e7]">Shear rate</td>
              <td className="px-4 py-3">Single, low (~1–10 s⁻¹)</td>
              <td className="px-4 py-3">Frequency-dependent (0.01–628 rad/s)</td>
            </tr>
            <tr className="border-b border-white/[0.06]/50">
              <td className="px-4 py-3 font-medium text-[#e4e4e7]">Information</td>
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        <div className="bg-[#050507]/80 border border-white/[0.03] rounded-2xl p-6">
          <h4 className="font-bold text-[#fafafa] mb-3">Key Insight</h4>
        ...
        <div className="bg-[#0c0c12]/40 border border-[#2dd4bf]/10 backdrop-blur-sm rounded-2xl p-6">
          <h4 className="font-bold text-[#2dd4bf] mb-3">Recycled Polymer Implication</h4>
          <p className="text-[#a1a1aa] text-sm">
      ...
      <div className="bg-[#0c0c12]/60 border border-white/[0.04] rounded-2xl backdrop-blur-sm p-6 mb-8">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <ol className="text-[#a1a1aa] text-sm list-decimal list-inside space-y-2">
            <li>
              <strong className="text-[#e4e4e7]">MFI</strong> — quick screening and
              lot-to-lot comparison (ASTM D1238)
            </li>
            <li>
              <strong className="text-[#e4e4e7]">Strain sweep</strong> — determine LVR
              boundary; reduced LVR indicates gel or filler
            </li>
            <li>
              <strong className="text-[#e4e4e7]">Frequency sweep</strong> (0.01–100 rad/s) —
              G&apos;, G&apos;&apos;, η*; extract η₀, crossover, MWD sensitivity
            </li>
            <li>
              <strong className="text-[#e4e4e7]">Time sweep</strong> (constant ω, γ₀) —
              thermal stability; detect degradation during measurement
            </li>
          </ol>
          <ol className="text-[#a1a1aa] text-sm list-decimal list-inside space-y-2" start={5}>
            <li>
              <strong className="text-[#e4e4e7]">Temperature sweep / TTS</strong> —
              a<sub>T</sub>(T) for processing window; detect immiscible contaminants
            </li>
            <li>
              <strong className="text-[#e4e4e7]">Capillary rheometry</strong> — high γ̇
              processing data with Bagley &amp; Rabinowitsch corrections
            </li>
            <li>
              <strong className="text-[#e4e4e7]">Extensional rheometry (SER)</strong> —
              melt strength and strain hardening for film/blow molding grades
            </li>
            <li>
              <strong className="text-[#e4e4e7]">van Gurp-Palmen plot</strong> — branching
      ...
      {/* References */}
      <div className="bg-[#050507]/80 border border-white/[0.03] rounded-2xl p-6">
        <h4 className="font-bold text-[#fafafa] mb-3">Key References — Rheometry</h4>
