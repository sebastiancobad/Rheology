  ...
  return (
    ...
    ═══════════════════════
         plate (fixed)`}</pre>
          ...
          <p className="text-[#94a3b8] text-xs mt-3 mb-2">
            <strong className="text-[#e2e8f0]">Advantages:</strong>
          </p>
          ...
          <p className="text-[#94a3b8] text-xs mt-2 mb-1">
            <strong className="text-[#e2e8f0]">Limitations:</strong>
          </p>
          <ul className="text-[#94a3b8] text-xs list-disc list-inside space-y-1">
    ...
    ═══════════════════════`}</pre>
      ...
      <div className="bg-[#1e293b] border border-[#334155] rounded-2xl p-6 mb-12">
        <h4 className="font-bold text-[#f1f5f9] mb-4">Other Geometries &amp; Special Configurations</h4>
        <div className="grid md:grid-cols-3 gap-6">
          <div>
            <h5 className="text-[#34d399] font-semibold text-sm mb-2">Concentric Cylinders (Couette)</h5>
            <p className="text-[#94a3b8] text-xs">
              Inner cylinder (bob) rotates within an outer cup. Excellent for low-viscosity
              fluids and suspensions. The <strong className="text-[#e2e8f0]">double-gap</strong>{" "}
          ...
          <div>
            <h5 className="text-[#f472b6] font-semibold text-sm mb-2">Vane Geometry</h5>
            <p className="text-[#94a3b8] text-xs">
          ...
          <div>
            <h5 className="text-[#f59e0b] font-semibold text-sm mb-2">Closed-Cavity Rheometers</h5>
            <p className="text-[#94a3b8] text-xs">
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        <div className="bg-[#1e293b] border border-[#334155] rounded-2xl p-6">
          ...
          <ol className="text-[#94a3b8] text-xs list-decimal list-inside space-y-1 mb-3">
      ...
      <div className="bg-[#1e293b] border border-[#334155] rounded-2xl p-6 mb-12">
        <h4 className="font-bold text-[#f1f5f9] mb-4">Advanced Capillary Rheometry</h4>
        <div className="grid md:grid-cols-3 gap-6">
          <div>
            <h5 className="text-[#38bdf8] font-semibold text-sm mb-2">Wall Slip Detection</h5>
            <p className="text-[#94a3b8] text-xs">
              <strong className="text-[#e2e8f0]">Mooney analysis:</strong> measure apparent
          ...
          <div>
            <h5 className="text-[#a78bfa] font-semibold text-sm mb-2">Pressure-Dependent Viscosity</h5>
            <p className="text-[#94a3b8] text-xs">
          ...
          <div>
            <h5 className="text-[#34d399] font-semibold text-sm mb-2">Entrance Flow Analysis (Cogswell)</h5>
            <p className="text-[#94a3b8] text-xs">
      ...
      <div className="bg-[#1e293b] border border-[#334155] rounded-2xl p-6 mb-12">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div>
            <h5 className="text-[#38bdf8] font-semibold text-sm mb-2">Slit-Die Rheometer</h5>
            <p className="text-[#94a3b8] text-xs">
          ...
          <div>
            <h5 className="text-[#a78bfa] font-semibold text-sm mb-2">Ultrasonic Rheometry</h5>
            <p className="text-[#94a3b8] text-xs">
              Non-invasive technique using ultrasonic wave propagation to measure
              G&apos; and G&apos;&apos; at MHz frequencies. The{" "}
              <strong className="text-[#e2e8f0]">Resonic</strong> system and similar
          ...
          <div>
            <h5 className="text-[#34d399] font-semibold text-sm mb-2">In-Process Monitoring</h5>
            <p className="text-[#94a3b8] text-xs">
        ...
        <table className="w-full text-sm text-left">
          ...
          <tbody className="text-[#94a3b8]">
            <tr className="border-b border-[#334155]/50">
              <td className="px-4 py-3 font-medium text-[#e2e8f0]">Standard</td>
              <td className="px-4 py-3">ASTM D1238 / ISO 1133</td>
              <td className="px-4 py-3">ASTM D4065 / ISO 6721</td>
            </tr>
            <tr className="border-b border-[#334155]/50">
              <td className="px-4 py-3 font-medium text-[#e2e8f0]">Measurement</td>
            ...
            <tr className="border-b border-[#334155]/50">
              <td className="px-4 py-3 font-medium text-[#e2e8f0]">Shear rate</td>
              <td className="px-4 py-3">Single, low (~1–10 s⁻¹)</td>
              <td className="px-4 py-3">Frequency-dependent (0.01–628 rad/s)</td>
            </tr>
            <tr className="border-b border-[#334155]/50">
              <td className="px-4 py-3 font-medium text-[#e2e8f0]">Information</td>
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        ...
        <div className="bg-gradient-to-r from-[#34d399]/5 to-[#38bdf8]/5 border border-[#34d399]/20 rounded-2xl p-6">
          <h4 className="font-bold text-[#34d399] mb-3">Recycled Polymer Implication</h4>
          <p className="text-[#94a3b8] text-sm">
      ...
      <div className="bg-[#1e293b] border border-[#334155] rounded-2xl p-6 mb-8">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <ol className="text-[#94a3b8] text-sm list-decimal list-inside space-y-2">
            <li>
              <strong className="text-[#e2e8f0]">MFI</strong> — quick screening and
              lot-to-lot comparison (ASTM D1238)
            </li>
            <li>
              <strong className="text-[#e2e8f0]">Strain sweep</strong> — determine LVR
              boundary; reduced LVR indicates gel or filler
            </li>
            <li>
              <strong className="text-[#e2e8f0]">Frequency sweep</strong> (0.01–100 rad/s) —
              G&apos;, G&apos;&apos;, η*; extract η₀, crossover, MWD sensitivity
            </li>
            <li>
              <strong className="text-[#e2e8f0]">Time sweep</strong> (constant ω, γ₀) —
              thermal stability; detect degradation during measurement
            </li>
          </ol>
          <ol className="text-[#94a3b8] text-sm list-decimal list-inside space-y-2" start={5}>
            <li>
              <strong className="text-[#e2e8f0]">Temperature sweep / TTS</strong> —
              a<sub>T</sub>(T) for processing window; detect immiscible contaminants
            </li>
            <li>
              <strong className="text-[#e2e8f0]">Capillary rheometry</strong> — high γ̇
              processing data with Bagley &amp; Rabinowitsch corrections
            </li>
            <li>
              <strong className="text-[#e2e8f0]">Extensional rheometry (SER)</strong> —
              melt strength and strain hardening for film/blow molding grades
            </li>
            <li>
              <strong className="text-[#e2e8f0]">van Gurp-Palmen plot</strong> — branching
      ...
      {/* References */}
      <div className="bg-[#0f172a] border border-[#334155] rounded-2xl p-6">
        <h4 className="font-bold text-[#f1f5f9] mb-3">Key References — Rheometry</h4>
