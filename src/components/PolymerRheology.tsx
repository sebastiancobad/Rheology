  ...
  return (
    ...
    >
      ...
      <SubSection title="Molecular Origin of Polymer Viscoelasticity">
        <div className="bg-[#1e293b] border border-[#334155] rounded-2xl p-6 mb-8">
          <p className="text-[#94a3b8] text-sm mb-4">
            ...
            <strong className="text-[#e2e8f0]">chain-like molecular architecture</strong>.
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h4 className="font-semibold text-[#38bdf8] mb-2">Rouse Model (Unentangled, M &lt; M<sub>c</sub>)</h4>
            ...
            <div>
              <h4 className="font-semibold text-[#a78bfa] mb-2">Reptation / Tube Model (Entangled, M &gt; M<sub>c</sub>)</h4>
              <p className="text-[#94a3b8] text-xs mb-2">
        ...
        <div className="bg-[#0f172a] border border-[#334155] rounded-2xl p-6 mb-8">
          <h4 className="font-bold text-[#f1f5f9] mb-3">
            ...
            <table className="w-full text-sm text-left">
              <thead>
                <tr className="border-b border-[#334155]">
                  <th className="px-4 py-2 text-[#f1f5f9]">Polymer</th>
                  <th className="px-4 py-2 text-[#f1f5f9]">M<sub>e</sub> (g/mol)</th>
                  <th className="px-4 py-2 text-[#f1f5f9]">G<sub>N</sub><sup>0</sup> (MPa)</th>
                  <th className="px-4 py-2 text-[#f1f5f9]">M<sub>c</sub> ≈ 2M<sub>e</sub></th>
                </tr>
              </thead>
      ...
      <SubSection title="Viscoelastic Characterization Experiments">
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <div className="bg-[#1e293b] border border-[#334155] rounded-2xl p-6">
            <h4 className="font-bold text-[#38bdf8] mb-3">Creep &amp; Creep Recovery</h4>
          ...
          <div className="bg-[#1e293b] border border-[#334155] rounded-2xl p-6">
            ...
            <p className="text-[#94a3b8] text-xs mt-3 mb-2">
              For the <strong className="text-[#e2e8f0]">Generalized Maxwell model</strong>{" "}
            ...
            <p className="text-[#94a3b8] text-xs mt-2">
              The <strong className="text-[#e2e8f0]">relaxation time spectrum H(λ)</strong>{" "}
          ...
          <div className="bg-[#1e293b] border border-[#334155] rounded-2xl p-6">
            <h4 className="font-bold text-[#34d399] mb-3">Oscillatory Shear (SAOS)</h4>
            <p className="text-[#94a3b8] text-sm mb-3">
            ...
            <p className="text-[#94a3b8] text-xs mt-3">
              <strong className="text-[#e2e8f0]">Critical prerequisite:</strong> Strain
        ...
        <div className="bg-[#1e293b] border border-[#334155] rounded-2xl p-6 mb-8">
          <div className="flex items-center gap-3 mb-4">
            <h4 className="font-bold text-[#f1f5f9]">
              Large-Amplitude Oscillatory Shear (LAOS)
            </h4>
            <span className="px-2 py-0.5 rounded bg-[#f472b6]/10 text-[#f472b6] text-xs font-semibold">
              Advanced Topic
            </span>
          </div>
          <p className="text-[#94a3b8] text-sm mb-4">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <p className="text-[#94a3b8] text-xs">
                ...
                characterizing <strong className="text-[#e2e8f0]">recycled polymer blends</strong>{" "}
        ...
        <div className="bg-[#1e293b] border border-[#334155] rounded-2xl p-6 mb-8">
          ...
          <div className="grid sm:grid-cols-3 gap-6 mb-6">
            <div>
              <h5 className="text-[#38bdf8] font-semibold mb-2">Maxwell Model</h5>
            ...
            <div>
              <h5 className="text-[#a78bfa] font-semibold mb-2">Kelvin-Voigt Model</h5>
              <p className="text-[#94a3b8] text-sm mb-2">
            ...
            <div>
              <h5 className="text-[#34d399] font-semibold mb-2">Generalized Maxwell</h5>
              <p className="text-[#94a3b8] text-sm mb-2">
          ...
          <div className="bg-[#0f172a] rounded-xl p-4">
            <h5 className="text-[#f59e0b] font-semibold text-sm mb-2">
              Nonlinear Constitutive Models (Beyond LVE)
            </h5>
            <p className="text-[#94a3b8] text-xs">
              For polymer processing where large deformations occur:{" "}
              <strong className="text-[#e2e8f0]">Wagner integral model</strong> (strain
              damping function h(γ)),{" "}
              <strong className="text-[#e2e8f0]">Pom-Pom model</strong> (for branched
              polymers, McLeish &amp; Larson, 1998),{" "}
              <strong className="text-[#e2e8f0]">Rolie-Poly</strong> (Likhtman &amp; Graham, 2003)
              for linear polymers. The{" "}
              <strong className="text-[#e2e8f0]">Giesekus model</strong> (1982) and{" "}
              <strong className="text-[#e2e8f0]">PTT model</strong> (Phan-Thien &amp; Tanner, 1977)
      ...
      <SubSection title="Dynamic Moduli — Storage &amp; Loss Modulus">
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-[#1e293b] border border-[#334155] rounded-2xl p-6">
            ...
            <p className="text-[#94a3b8] text-xs mt-3">
              ...
              The <strong className="text-[#e2e8f0]">van Gurp-Palmen plot</strong>{" "}
        ...
        <div className="bg-[#1e293b] border border-[#334155] rounded-2xl p-6 mb-8">
          <div className="flex items-center gap-3 mb-2">
            <h4 className="font-bold text-[#f1f5f9]">Damping Factor &amp; Cole-Cole Analysis</h4>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div>
              <h5 className="text-[#a78bfa] font-semibold text-sm mb-2">Cole-Cole Plot</h5>
              <p className="text-[#94a3b8] text-xs mb-2">
                The <strong className="text-[#e2e8f0]">Cole-Cole plot</strong> (η&apos;&apos; vs. η&apos;)
        ...
        <div className="bg-[#0f172a] border border-[#334155] rounded-2xl p-6 mb-8">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="bg-[#1e293b] rounded-xl p-4">
              <h5 className="text-[#38bdf8] font-semibold text-sm mb-2">Molecular Weight</h5>
              <p className="text-[#94a3b8] text-xs">
            ...
            <div className="bg-[#1e293b] rounded-xl p-4">
              <h5 className="text-[#a78bfa] font-semibold text-sm mb-2">Long-Chain Branching</h5>
              <p className="text-[#94a3b8] text-xs">
            ...
            <div className="bg-[#1e293b] rounded-xl p-4">
              <h5 className="text-[#34d399] font-semibold text-sm mb-2">Degradation Detection</h5>
              <p className="text-[#94a3b8] text-xs">
      ...
      <SubSection title="Temperature Effects — Time-Temperature Superposition">
        <div className="bg-[#1e293b] border border-[#334155] rounded-2xl p-6 mb-8">
          <p className="text-[#94a3b8] mb-4">
            <strong className="text-[#e2e8f0]">TTS</strong> states that changing
            temperature is equivalent to shifting the frequency scale by a<sub>T</sub>.
            This constructs <strong className="text-[#e2e8f0]">master curves</strong>{" "}
          ...
          <p className="text-[#94a3b8] text-sm mt-3">
            ...
            <strong className="text-[#e2e8f0]">thermorheological simplicity</strong> —
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <div className="bg-[#1e293b] border border-[#334155] rounded-2xl p-6">
            <h4 className="font-bold text-[#38bdf8] mb-3">WLF Equation</h4>
            <p className="text-[#94a3b8] text-sm mb-3">
            ...
            <div className="overflow-x-auto mt-3">
              <table className="w-full text-xs">
                <thead>
                  <tr className="border-b border-[#334155]">
                    <th className="px-2 py-1 text-left text-[#f1f5f9]">Polymer</th>
                    <th className="px-2 py-1 text-left text-[#f1f5f9]">C₁</th>
                    <th className="px-2 py-1 text-left text-[#f1f5f9]">C₂ (K)</th>
                  </tr>
                </thead>
                <tbody className="text-[#94a3b8]">
          ...
          <div className="bg-[#1e293b] border border-[#334155] rounded-2xl p-6">
            <h4 className="font-bold text-[#a78bfa] mb-3">Arrhenius Equation</h4>
            <p className="text-[#94a3b8] text-sm mb-3">
            ...
            <div className="overflow-x-auto mt-3">
              <table className="w-full text-xs">
                <thead>
                  <tr className="border-b border-[#334155]">
                    <th className="px-2 py-1 text-left text-[#f1f5f9]">Polymer</th>
                    <th className="px-2 py-1 text-left text-[#f1f5f9]">E<sub>a</sub> (kJ/mol)</th>
                  </tr>
                </thead>
                <tbody className="text-[#94a3b8]">
                  <tr className="border-b border-[#334155]/30">
        ...
        {/* TTS Failure */}
        <div className="bg-gradient-to-r from-[#f472b6]/5 to-[#a78bfa]/5 border border-[#f472b6]/20 rounded-2xl p-6">
          <h4 className="font-bold text-[#f1f5f9] mb-3">
          ...
          <ul className="text-[#94a3b8] text-sm list-disc list-inside space-y-2">
            <li>
              <strong className="text-[#e2e8f0]">Long-chain branched polymers</strong> — branch
              retraction and backbone reptation have different activation energies.
            </li>
            <li>
              <strong className="text-[#e2e8f0]">Immiscible polymer blends</strong> — each
              phase has its own a<sub>T</sub>(T), plus interfacial relaxation.
              Critical for recycled streams with contaminants.
            </li>
            <li>
              <strong className="text-[#e2e8f0]">Semi-crystalline polymers near T<sub>m</sub></strong>{" "}
              — crystallization kinetics violate TTS.
            </li>
            <li>
              <strong className="text-[#e2e8f0]">Block copolymers</strong> — microphase
              separation creates distinct thermal responses.
            </li>
          </ul>
          <p className="text-[#94a3b8] text-xs mt-3">
            <strong className="text-[#f59e0b]">Literature gap:</strong> TTS applicability for
      ...
      <SubSection title="Extensional Rheology">
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <div className="bg-[#1e293b] border border-[#334155] rounded-2xl p-6">
            ...
            <p className="text-[#94a3b8] text-sm mt-3 mb-2">
              <strong className="text-[#e2e8f0]">Trouton&apos;s ratios</strong> (Newtonian):
            </p>
            <div className="math-block text-sm">
          ...
          <div className="bg-[#1e293b] border border-[#334155] rounded-2xl p-6">
            ...
            <p className="text-[#94a3b8] text-sm mb-3">
              <strong className="text-[#e2e8f0]">Strain hardening factor</strong>:
            </p>
            <div className="math-block text-sm">
        ...
        <div className="bg-[#1e293b] border border-[#334155] rounded-2xl p-6 mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h5 className="text-[#38bdf8] font-semibold text-sm mb-2">SER Fixture</h5>
              <p className="text-[#94a3b8] text-xs">
            ...
            <div>
              <h5 className="text-[#a78bfa] font-semibold text-sm mb-2">CaBER &amp; FiSER</h5>
              <p className="text-[#94a3b8] text-xs">
        ...
        <div className="bg-gradient-to-r from-[#38bdf8]/5 to-[#34d399]/5 border border-[#38bdf8]/20 rounded-2xl p-6">
          <div className="flex items-center gap-3 mb-4">
          ...
          <p className="text-[#94a3b8] text-sm mb-3">
            Recycled polymers typically show <strong className="text-[#e2e8f0]">reduced melt
            strength</strong> due to chain scission, LCB loss, and MWD narrowing.
          </p>
          <p className="text-[#94a3b8] text-sm mb-2">
            <strong className="text-[#e2e8f0]">Remediation strategies:</strong>
          </p>
          <ul className="text-[#94a3b8] text-sm list-disc list-inside space-y-1">
            <li>
              <strong className="text-[#e2e8f0]">Chain extenders for PET:</strong> Joncryl
              increases IV from 0.60 to 0.80+ dL/g (Awaja &amp; Pavel, 2005)
            </li>
            <li>
              <strong className="text-[#e2e8f0]">Peroxide-induced LCB for PP:</strong> 0.01–0.1
              wt% organic peroxide creates LCB during reactive extrusion
              (Lagendijk et al., 2001)
            </li>
            <li>
              <strong className="text-[#e2e8f0]">Blending:</strong> 20% LDPE in rPE restores
      ...
      <div className="bg-[#0f172a] border border-[#334155] rounded-2xl p-6">
        <h4 className="font-bold text-[#f1f5f9] mb-3">Key References — Polymer Rheology</h4>
