  ...
  return (
    ...
    >
      ...
      <div className="grid lg:grid-cols-3 gap-6 mb-12">
        {/* Extrusion */}
        <div className="bg-[#f8f8fa] border border-[#e4e4e7] rounded-2xl p-6 flex flex-col">
          <div className="w-12 h-12 rounded-xl bg-[#4f46e5]/8 flex items-center justify-center mb-4">
            <svg className="w-6 h-6 text-[#4f46e5]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
              <path d="M13 5l7 7-7 7M5 5l7 7-7 7" />
            </svg>
          </div>
          <h4 className="font-bold text-[#18181b] text-lg mb-3">Extrusion</h4>
          <p className="text-[#6b7280] text-sm mb-4 flex-grow">
            ...
            <strong className="text-[#18181b]">shear flow</strong> inside the
          ...
          <div className="space-y-3">
            <div className="bg-white rounded-xl border border-[#f0f0f2] p-3">
              <h5 className="text-[#4f46e5] text-xs font-semibold mb-1">
                Key Rheological Parameters
              </h5>
              <ul className="text-[#6b7280] text-xs space-y-1 list-disc list-inside">
            ...
            <div className="bg-white rounded-xl border border-[#f0f0f2] p-3">
              ...
              <ul className="text-[#6b7280] text-xs space-y-1 list-disc list-inside">
                <li>
                  <strong className="text-[#18181b]">Sharkskin:</strong> Extensional stress
                  at die exit. Remediation: slip agents, die coating (Hatzikiriakos, 2012)
                </li>
                <li>
                  <strong className="text-[#18181b]">Die swell:</strong> B = 1.1–1.5 for HDPE,
                  up to 2.0+ for LDPE
                </li>
                <li>
                  <strong className="text-[#18181b]">Melt fracture:</strong> Gross distortion
        ...
        {/* Injection Molding */}
        <div className="bg-[#f8f8fa] border border-[#e4e4e7] rounded-2xl p-6 flex flex-col">
          <div className="w-12 h-12 rounded-xl bg-[#7c3aed]/8 flex items-center justify-center mb-4">
            <svg className="w-6 h-6 text-[#7c3aed]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
              <path d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
            </svg>
          </div>
          <h4 className="font-bold text-[#18181b] text-lg mb-3">Injection Molding</h4>
          <p className="text-[#6b7280] text-sm mb-4 flex-grow">
          ...
          <div className="space-y-3">
            <div className="bg-white rounded-xl border border-[#f0f0f2] p-3">
              <h5 className="text-[#7c3aed] text-xs font-semibold mb-1">
                Key Rheological Parameters
              </h5>
              <ul className="text-[#6b7280] text-xs space-y-1 list-disc list-inside">
        ...
        {/* Blow Molding */}
        <div className="bg-[#f8f8fa] border border-[#e4e4e7] rounded-2xl p-6 flex flex-col">
          <div className="w-12 h-12 rounded-xl bg-[#0d9488]/8 flex items-center justify-center mb-4">
            <svg className="w-6 h-6 text-[#0d9488]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
              <path d="M12 2a10 10 0 0110 10c0 5.523-4.477 10-10 10S2 17.523 2 12 6.477 2 12 2z" />
              <path d="M12 6v6l4 2" />
            </svg>
          </div>
          <h4 className="font-bold text-[#18181b] text-lg mb-3">Blow Molding</h4>
          <p className="text-[#6b7280] text-sm mb-4 flex-grow">
            A parison is extruded and inflated. Subjected to{" "}
            <strong className="text-[#18181b]">biaxial extension</strong> during inflation.
            For stretch blow molding (PET), the preform is biaxially stretched above
            T<sub>g</sub>, inducing strain-induced crystallization.
          </p>
          <div className="space-y-3">
            <div className="bg-white rounded-xl border border-[#f0f0f2] p-3">
              <h5 className="text-[#0d9488] text-xs font-semibold mb-1">
                Key Rheological Parameters
              </h5>
              <ul className="text-[#6b7280] text-xs space-y-1 list-disc list-inside">
          ...
          <table className="w-full text-sm text-left">
            <thead>
              <tr className="border-b border-[#e5e7eb]">
                <th className="px-4 py-2 text-[#18181b] font-semibold">Process</th>
                <th className="px-4 py-2 text-[#18181b] font-semibold">γ̇ (s⁻¹)</th>
                <th className="px-4 py-2 text-[#18181b] font-semibold">Primary Flow</th>
                <th className="px-4 py-2 text-[#18181b] font-semibold">Instrument</th>
                <th className="px-4 py-2 text-[#18181b] font-semibold">Key Parameter</th>
              </tr>
            </thead>
      ...
      <div className="bg-[#f8f8fa] border border-[#0d9488]/10 rounded-2xl p-6 mb-8">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-6">
          <div className="bg-[#f4f4f5] rounded-xl p-4">
            <h5 className="text-[#0d9488] font-semibold text-sm mb-2">
            ...
            <p className="text-[#6b7280] text-xs">
              <strong className="text-[#18181b]">Solutions:</strong> SSP at 200–220°C
          ...
          <div className="bg-[#f4f4f5] rounded-xl p-4">
            ...
            <p className="text-[#6b7280] text-xs">
              <strong className="text-[#18181b]">Solutions:</strong> SEBS or EPR
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-[#f4f4f5] rounded-xl p-4">
            ...
            <p className="text-[#6b7280] text-xs">
              ...
              further degradation.{" "}
              <strong className="text-[#d97706]">Literature gap:</strong> Rheological
      ...
      <div className="bg-[#f8f8fa] border border-[#e4e4e7] rounded-2xl p-6 mb-8">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          <div className="bg-white rounded-xl border border-[#f0f0f2] p-3">
            <h5 className="text-[#4f46e5] text-xs font-semibold mb-1">Printability Window</h5>
            <p className="text-[#6b7280] text-xs">
          ...
          <div className="bg-white rounded-xl border border-[#f0f0f2] p-3">
            <h5 className="text-[#7c3aed] text-xs font-semibold mb-1">Layer Welding</h5>
            <p className="text-[#6b7280] text-xs">
          ...
          <div className="bg-white rounded-xl border border-[#f0f0f2] p-3">
            <h5 className="text-[#0d9488] text-xs font-semibold mb-1">Recycled Filaments</h5>
            <p className="text-[#6b7280] text-xs">
      ...
      <div className="bg-white border border-[#e4e4e7] rounded-2xl p-6">
        <h4 className="font-bold text-[#18181b] mb-3">Key References — Processing</h4>
